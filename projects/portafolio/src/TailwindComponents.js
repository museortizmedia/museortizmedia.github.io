const TailwindComponents = {
  ...
  MarkDownStyle: {
    ...
    H1: 'text-4xl font-bold text-zinc-700 dark:text-zinc-400 mb-4',
    H2: 'text-3xl font-semibold text-zinc-700 dark:text-zinc-400 mb-3',
    ListDisc: 'list-disc ml-5 mb-1',
    ListDecimal: 'list-decimal ml-5 mb-1',
    Strong: 'font-bold',
    Em: 'italic',
    Img: 'max-w-full h-auto mb-4',
    A: 'text-rose-700 underline',
    P: 'mb-4 text-zinc-700 dark:text-zinc-400'
  }
};
